...
import { isResumeQueueEnabled } from "../queues/resumeQueue.js";
...
if (isResumeQueueEnabled && bullmqRedisConnection) {
    ...
    console.warn('[resume-worker] Worker disabled because Redis/BullMQ is unavailable.');
}
